            ...
            <div class="col-md-9 col-md-push-3">
                <div class="banner banner-top">
                    ...
                    <div class="banner-content">
                        <h2   style="background-color: #dadada;color: #ff7700">COUP D'OEIL SUR NOS<br>MOTEURS</h2>
                ...
                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="dataindefinigroupe">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {indefinigroupe: 'indefinigroupe'},
                success: function (result) {
                    $("#dataindefinigroupe").append(result);
