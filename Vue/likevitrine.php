        ...
        <div class="row">
            <div class="col-md-9 col-md-push-3">
                <div class="banner banner-top">
                    <img style="height: 350px" src="assets/images/banners/meubleetbureau.png" alt="Banner">
                    <div class="banner-content">
                        <h2   style="background-color: #dadada;color: #ff7700">COUP D'OEIL SUR NOS<br>MEUBLES</h2>
                ...
                <div class="category-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">CHAISE</li>
                    </ol>
                </div>

                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="datalikevitrine">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {likevitrine: 'likevitrine'},
                success: function (result) {
                    $("#datalikevitrine").append(result);
