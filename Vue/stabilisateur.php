        ...
        <div class="row">
            <div class="col-md-9 col-md-push-3">
                <div class="banner banner-top">
                    <img style="height: 350px" src="assets/images/banners/kitsolaire.png" alt="Banner">
                ...
                <div class="category-header">
                    <h1>SOLAIRE ET ELECTRICITE</h1>
                    <ol class="breadcrumb">
                        <li><a href="#">SOLAIRE ET ELECTRICITE</a></li>
                        <li class="active">STABILISATEUR</li>
                    </ol>
                </div>

                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="datastabilisateur">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {stabilisateur: 'stabilisateur'},
                success: function (result) {
                    $("#datastabilisateur").append(result);
