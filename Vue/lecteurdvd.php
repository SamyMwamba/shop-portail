            ...
            <div class="col-md-9 col-md-push-3">
                ...
                <div class="category-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">LECTEUR DVD</li>
                    </ol>
                </div>

                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="datalecteurdvd">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {lecteurdvd: 'lecteurdvd'},
                success: function (result) {
                    $("#datalecteurdvd").append(result);
