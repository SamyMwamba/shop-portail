            ...
            <div class="col-md-9 col-md-push-3">
                ...
                <div class="category-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">PANNEAU SOLAIRE</li>
                    </ol>
                </div>

                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="datapanneau">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {panneau: 'panneau'},
                success: function (result) {
                    $("#datapanneau").append(result);
