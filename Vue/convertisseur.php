            ...
            <div class="col-md-9 col-md-push-3">
                ...
                <div class="category-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">CONVERTISSEUR</li>
                    </ol>
                </div>

                <div class="DETAILS-row">
                    <div class="DETAILS-container max-col-4" data-layout="fitRows" id="dataconvertisseur">
    ...
    $('document').ready(function()
        {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {convertisseur: 'convertisseur'},
                success: function (result) {
                    $("#dataconvertisseur").append(result);
