            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    <div class="banner banner-top">
                        <img src="assets/images/banners/meubleetbureau.png" alt="Banner">
                    ...
                    <div class="category-header">
                        <h1>Tout</h1>
                        <ol class="breadcrumb">
                            <li><a href="#">Resultat Recherche</a></li>
                            <li class="active">Article</li>
                        </ol>
                    </div>

                    <div class="DETAILS-row">
                        <div class="DETAILS-container max-col-4" data-layout="fitRows" id="datasearch">
